...
method.args = list(family = "binomial")) + facet_wrap(~pid7)+ xlab(' Immigration attitude ') + ylab('Voted for Trump') + ggtitle('Fit of Logistic Regression using immigration attitude') + theme(plot.title = element_text(size = 12, face = "bold", hjust = 0.5)) + scale_colour_manual(values=cbPalette)
```
...
method.args = list(family = "binomial"),se=FALSE)+xlab('Pro Immigration') + ylab('Voted for Trump') + ggtitle('Fit of Logistic Regression using immigration attitude') + theme(plot.title = element_text(size = 12, face = "bold", hjust = 0.5)) + scale_colour_manual(values=cbPalette)
```
...
geom_jitter(height = 0.1, width = 0.25) +
geom_smooth(method = "glm",color = "#56B4E9" ,
method.args = list(family = "binomial")) + facet_wrap(~educ)+ xlab('Immigration attitude') + ylab('Voted for Trump') + ggtitle('Fit of Logistic Regression using immigration attitude with respect to Party identification')+ theme(plot.title = element_text(size = 12, face = "bold", hjust = 0.5))
```
```{r,include= FALSE}
ggplot(obama, aes(x = pro.img, y = isTrump)) +
geom_jitter(height = 0.1, width = 0.25) +
geom_smooth(method = "glm",color = "#56B4E9" ,
method.args = list(family = "binomial")) + facet_wrap(~race)+ xlab('Immigration attitude') + ylab('Voted for Trump') + ggtitle('Fit of Logistic Regression using immigration attitude with respect to race')+ theme(plot.title = element_text(size = 12, face = "bold", hjust = 0.5))
```
```{r , echo=FALSE , include= FALSE}
ggplot(obama, aes(x = pro.img, y = isTrump)) +
geom_jitter(height = 0.1, width = 0.25) +
geom_smooth(method = "glm",color = "#56B4E9" ,
method.args = list(family = "binomial")) + facet_wrap(~gender)+ xlab('Pro Immigration') + ylab('Voted for Trump') + ggtitle('Fit of Logistic Regression using immigration attitude with respect to Gender')+ theme(plot.title = element_text(size = 12, face = "bold", hjust = 0.5))
```
